    ...
    <div className="home-container">
      ...
      <div className='instructions'>Instructions:
        <ul>
          ...
          <li>2) Once loaded, select "Matches" in the header. Scroll down to view all matches.</li>
          <li>3) Select the match you'd like to analyze.</li>
          <li>4) Copy the entire table onto clipboard and paste under in the empty textbox.</li>
          <li>5) Enter your agent and press Convert! This should render this data into the table on the right.</li>
          <li>6) Double check the information, if correct, select Analyze to process a game analysis. </li>
          <li>7) Hang tight while it runs! The most recent analysis will always be rendered underneath.</li>
          <li>Below our most recent analysis will be a list of all past matches!</li>
        </ul>
      </div>
